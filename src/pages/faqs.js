...
const faqData = [
  {
    ...
    ans: "R Centric is the short-term rental entity managed by LIV Property Management LLC. In partnership with Me by Melia Dubai, R Centric will take care of the day-to-day management and operation of your luxury apartment.",
  },
  {
  ...
  },
  {
    ...
    ans: "ME by Melia and R Centric will visit your unit with a detailed checklist to facilitate a comprehensive handover. We and/or your appointed representative, along with R Centric, will fill in the details on this checklist to ensure that the full list of FF&E, appliances, and OS&E is itemised and the status in your apartment is confirmed.",
  },
  {
  ...
  },
  {
    ...
    ans: "Cancel your existing contracts with third-party facility management companies. R Centric will share a regular maintenance schedule as and when provided by Me by Melia Dubai.",
  },
  {
  ...
  {
    ques: "What if R Centric cannot generate acceptable revenue through this Programme? Can I terminate the Individual Rental Pool Agreement without facing punitive actions if I exclusively list my unit with LIV Property Services Co for long-term rent?",
    ans: "R Centric and LIV Property Services Co are two separate businesses and, as such, have no administrative control over the other. LIV Property Services Co, however, will still be able to assist you in finding a buyer for your apartment while under contract with R Centric for the Individual Rental Pool Agreement.",
  },
  {
  ...
  },
  {
    ...
    ans: "Your 14-day entitlement is subject to advance booking notice periods that R Centric and Me by Melia Dubai and will implement, with consideration for advanced notice blackout dates.",
  },
  {
    ques: "Where do I register or get more information on R Centric?",
  ...
  },
  {
    ...
    ans: "R Centric and Me by Melia Dubai shall, at the time of the signature of your contract, conduct an inspection of your unit to ensure it meets the brand standard. If the FF&E and appliances are kept in the unit as per the SPA – the apartment is within brand standard. If they are not, you will be notified by R Centric to rectify the situation.",
  },
  {
    ques: "Who will pay for my or my family’s stay during my 14 days entitlement?",
    ans: "R Centric shall deduct from your share any operating costs that may be payable by you during your stay.\n\nIf you dined at any of our partner Food and Beverage operators within the hotel, you would need to pay at the restaurant. Only meals taken at Me Dubai outlets may be charged to your apartment.",
  },
  {
    ques: "Who should I complain to if I am not satisfied with how Me by Melia or R Centric Dubai is operating my apartment?",
    ans: "For prompt attention to your concerns, contact R Centric at assetmanagement@omniyat.com.\n\n Me by Melia Dubai is contracted by R Centric to operate the apartments. The Hotel Operator is not authorised by the Hotel Owner to enter into an agreement with the Unit Owner.",
  },
  {
    ques: "Who is going to pay for the Service Charges of my apartment levied by Mollak?",
    ans: "This bill will come to you directly from Mollak and shall be settled by you through the Mollak system. R Centric shall manage your property, ensuring that you make up-to-date payments through Mollak.\n\nWho is responsible for the monthly DEWA, Internet, and other utilities payment of my apartment? These are called Property Expenses on your Individual Rental Program Agreement. R Centric shall pay for the utilities on your behalf. The funds shall be taken out from the unit’s Gross Rental Programme Revenue.",
  },
  {
    ques: "Why choose R Centric?",
    ans: "Stay with the family, have regular access with a reputable operator, and enjoy a worry-free investment. Professional maintenance of your apartment ensures an annual, regular and dynamic income. \n\nR Centric is committed to maintaining the brand standard, not only for Me by Melia Dubai, by offering bespoke 5-star service to discerning guests. Additionally, R Centric ensures that Zaha Hadid’s legacy lives on. The Opus by OMNIYAT is one of Zaha Hadid’s last collaborations. Through sophisticated guest screening processes and meticulous preventative schedules, along with timely reactive maintenance, you can be assured that your exquisitely designed apartment will remain a sound investment for years to come.",
  },
  {
